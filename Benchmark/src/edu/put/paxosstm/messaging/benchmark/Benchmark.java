...
import edu.put.paxosstm.messaging.benchmark.config.LocalEnvironment;
import edu.put.paxosstm.messaging.benchmark.config.SshEnvironment;
...
public class Benchmark {
    ...
    private void setupPaxos() {
        ...
        Parameters.JVM_SETTINGS = "-Xmx1g -Xms512m";
    }
