...
import edu.put.paxosstm.messaging.benchmark.core.*;
import edu.put.paxosstm.messaging.benchmark.scenarios.QueueWithTransactionScenario;
import edu.put.paxosstm.messaging.benchmark.scenarios.SimpleQueueScenario;
import edu.put.paxosstm.messaging.benchmark.scenarios.SimpleTopicScenario;
    ...
    static Class<? extends Scenario> getScenarioClass(AvailableScenarios scenarioType) throws ArgumentParsingException {
        ...
        switch  (scenarioType) {
            case SimpleQueue:
                ...
                break;
            case TransactionalQueue:
                scenarioClass = QueueWithTransactionScenario.class;
                break;
            case SimpleTopic:
